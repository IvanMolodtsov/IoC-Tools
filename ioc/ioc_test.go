...
func TestRegister(t *testing.T) {
	...
	registerCommand, err := ioc.Resolve[common.ICommand]("IoC.REGISTER", "key", dep)
	if err != nil {
		t.Error(err.Error())
	}
	...
	c, _ := ioc.Resolve[common.ICommand]("IoC.REGISTER", "key")
	c.Invoke()
}
...
func TestExecuteInNewScope(t *testing.T) {
	...
	var test = 0
	c, err := ioc.Resolve[common.ICommand]("IoC.EXECUTE_IN_NEW_SCOPE", func() error {
		registerCommand, _ := ioc.Resolve[common.ICommand]("IoC.REGISTER", "key", dep)
